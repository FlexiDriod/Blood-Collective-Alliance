...
<html lang="en">
    ...
    $sql = "SELECT donorname,donordob,donorgender,donorbloodgrp,donormobile,donoremail,donorpincode,donorstate,donordistrict,donoraddress,donoraltno, donorphoto FROM donor_info WHERE donoremail = $1";
    $result = pg_query_params($db_connect, $sql, array($donorEmail));
    //fetching data from database using session 

    if ($result) {
        $row = pg_fetch_assoc($result);
        $donorName = $row['donorname']; //Trying to access array offset on value of type bool
    ...
    <body>
        ...
        <div class="mainsec">
            <span class="SPAN">
                <form id="editForm" method="POST" action="settings.php" autocomplete="off" enctype="multipart/form-data" onchange="">
                            ...
                            <div class="card card-container"
                                ...
                                <div class="form-group">
                                    <div class="d-flex justify-content-center mb-4">
                                        ...
                                        <img id="selectedAvatar" name="donorPhoto" src="<?php  echo $donorPhoto; ?>" class="rounded-circle"
                                             style="width: 200px; height: 200px; object-fit:fill;"
                                             alt="Image Preview" />
                                    </div>
                                    <div class="d-flex justify-content-center">
                                        <div data-mdb-ripple-init class="btn btn-primary btn-rounded">
                                            <label class="form-label text-white mx-auto" for="donorPhoto">Choose file</label>
                                            ...
                                            <script>
                                                function displaySelectedImage (event, elementId) {
                                                    var preview = document.querySelector('#selectedAvatar');
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" class="form-control" id="txtBbFName" name="newDonorName"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select name="newDonorGender" class="form-control" >
                                                <option value="<?php echo $donorGender; ?>">
                                                    <?php echo $donorGender; ?>
                                                </option>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="tel" class="form-control" name="newDonorMobile" id="txtBbMobile"
                                                   maxlength="10" value="<?php echo $donorMobile; ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <select name="newDonorBloodGrp" class="form-control" id="newDonorBloodGrp">
                                                <option value="<?php echo $donorBloodGrp; ?> ">
                                                    <?php echo $donorBloodGrp; ?>
                                                </option>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" class="form-control" name="newDonorpincode" id="txtBbPincode"
                                                   maxlength="6" value="<?php echo $donorpincode; ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <select class="form-control" id="inputState" name="newDonorState">
                                                <option value="<?php echo $donorState; ?>">
                                                    <?php echo $donorState; ?>
                                                </option>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select class="form-control" id="inputDistrict" name="newDonorDistrict">
                                                <option value=" <?php echo $donorDistrict; ?>">
                                                <?php echo $donorDistrict; ?>
                                                </option>
                                            </select>
                                            </select>
                                    </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["donorPhoto"])) {
    ...
    $Crnt_imageData = $_FILES["donorPhoto"]["name"];
    $Crnt_imagetmp = $_FILES["donorPhoto"]["tmp_name"];

    // Sanitize input here

    // Update the donor photo only if a new image is uploaded
    // Default to the existing image data
    $new_img_name = $Crnt_imageData; 
    if ($_FILES['donorPhoto']['name']) {
        $new_img_name = '';
        $Crnt_imageData = $_FILES['donorPhoto']['name'];
        ...
        if (in_array($img_ex_lc, $allow_extn)) {
            ...
            move_uploaded_file($_FILES['donorPhoto']['tmp_name'], $img_upload_path);
  ...
  <script>
    ...
    function dismissModalAndRedirect() {
        ...
        window.location.href = 'settings.php'; // Redirect to AboutUs.php
    }
