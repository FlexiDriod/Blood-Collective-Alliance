    ...
    <!-- Sudip's Bio --!>
      ...
      <!-- Trinankur's Bio --!> 
       <li class='member'>
            ...
            <div class='container-md description-odd'>
                <p class='text-justify fs-5'>
                    Trinankur, a final-year BCA student at Burdwan Raj College, played a crucial role in bringing the 'Blood Collective Alliance' website to life. His expertise spans C/C++, C#, .NET, Python, and PHP. In collaboration with Sudip Howlader, Trinankur took charge of backend development using PHP, providing essential guidance and technical leadership throughout the project. Trinankur was instrumental in transforming Sudip's idea into a tangible reality, leveraging his skills to ensure the project's success. His proficiency in backend technologies and collaborative spirit were pivotal in the development and implementation of the website.
                    <br>
